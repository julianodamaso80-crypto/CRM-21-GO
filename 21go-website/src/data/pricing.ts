...
export const PLAN_INFO: Record<PlanId, PlanInfo> = {
  'basico': {
    id: 'basico',
    name: 'Básico',
    description: 'Proteção essencial contra roubo e furto',
    features: [
  ...
  'do-seu-jeito': {
    id: 'do-seu-jeito',
    name: 'Do Seu Jeito',
    description: 'Tudo do Básico + colisão, incêndio e mais',
    features: [
      { text: 'Roubo e Furto (reembolso FIPE)', included: true },
      { text: 'Assistência 24h', included: true },
  ...
  'vip': {
    id: 'vip',
    name: 'VIP',
    description: 'Tudo do "Do Seu Jeito" + carro reserva e vidros',
    popular: true,
    features: [
      { text: 'Roubo e Furto (reembolso FIPE)', included: true },
      { text: 'Assistência 24h', included: true },
  ...
  'premium': {
    id: 'premium',
    name: 'Premium',
    description: 'Tudo do VIP com máxima proteção',
    features: [
      { text: 'Roubo e Furto (reembolso FIPE)', included: true },
      { text: 'Assistência 24h', included: true },
      { text: 'Guincho/Reboque 600km', included: true, upgrade: true },
      { text: 'Colisão Total e Parcial', included: true },
      { text: 'Incêndio e Eventos da Natureza', included: true },
